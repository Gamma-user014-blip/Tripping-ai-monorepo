...
const TRIP_BUILDER_URL = process.env.TRIP_BUILDER_URL || 'http://trip_builder:8000';

/**
 * Calls the trip_builder service to create a final trip layout.
 */
export async function createTrip(request: TripRequest): Promise<FinalTripLayout> {
